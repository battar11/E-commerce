        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["id"] != null)
                {
                    if (Session["Buyitems"] == null)
                    {
                        ...
                        dr = dt.NewRow();
                        SqlConnection conn = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\USER\source\repos\WebApplication60000\WebApplication60000\App_Data\Database1.mdf;Integrated Security=True");
                    ...
                    else
                    {
                        ...
                        dr = dt.NewRow();
                        SqlConnection scon = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\USER\source\repos\WebApplication60000\WebApplication60000\App_Data\Database1.mdf;Integrated Security=True");
            ...
            if (Session["userN"] == null)
            {
                ...
                for (int i = 0; i <= dt.Rows.Count - 1; i++)
                {
                    SqlConnection scon = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\USER\source\repos\WebApplication60000\WebApplication60000\App_Data\Database1.mdf;Integrated Security=True");
                    scon.Open();
                    SqlCommand cmd = new SqlCommand("insert into OrderDetalis(orderid,sno,productid,productname,price,quantity,orderdate) values('" + Session["Orderid"] + "',"
            + dt.Rows[i]["sno"] + "," + dt.Rows[i]["pid"] + ",'" + dt.Rows[i]["pname"] + "'," + dt.Rows[i]["pprice"] + "," + dt.Rows[i]["pquantity"] + ",'" + Session["Orderdate"] + "')", scon);
                    ...
                    {
                        Response.Write("You cart is empty");
